 ...
 */
export function validateSignatureEvent(data: unknown): SignatureEvent {
  if (!isObject(data)) {
 ...
 */
export function validateReflexionEvent(data: unknown): ReflexionEvent {
  if (!isObject(data)) {
  ...
  return {
    ...
    input: data.input,
    output: data.output,
    verdict: data.verdict as 'correct' | 'incorrect' | 'partial',
    agentId: data.agentId,
    sessionId: data.sessionId,
 ...
 */
export function validateConsensusEvent(data: unknown): ConsensusEvent {
  if (!isObject(data)) {
