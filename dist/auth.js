...
export async function validateApiKey(apiKey) {
    ...
    const cached = await kvGet(apiKey, KV_PREFIXES.AUTH);
 ...
 */
export async function clearAuthCache(apiKey) {
    if (apiKey) {
 ...
 */
export async function createApiKey(projectId, projectName, settings) {
    const supabase = getSupabaseClient();
 ...
 * Returns new API key
 */
export async function rotateApiKey(projectId) {
    const supabase = getSupabaseClient();
 ...
 * @throws UnauthorizedError if authentication fails
 */
export async function authenticateIrisRequest(request) {
    const apiKey = extractApiKey(request);
    if (!apiKey) {
 ...
 * }
 */
export async function withIrisAuth(request, handler) {
    try {
 ...
 * @throws UnauthorizedError if authentication fails
 */
export async function authenticateIrisRequestVercel(req) {
 ...
 * }
 */
export async function withIrisAuthVercel(req, res, handler) {
    try {
