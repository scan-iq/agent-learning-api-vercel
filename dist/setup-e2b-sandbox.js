 ...
 */
export async function setupIrisSandbox(options) {
 ...
 */
async function createIrisWrapper(sandbox, projectId) {
    const wrapperCode = `
/**
 ...
 */
async function verifyMcpConnection(sandbox) {
    const testCode = `
 ...
 */
export async function installPackages(sandbox, packages) {
 ...
 */
export async function configureSandboxEnv(sandbox, envVars) {
 ...
 */
export async function healthCheck(sandbox) {
    const checkCode = `
    import { iris } from './iris-prime';
